...
ALLOWED_HOSTS = ['www.nntexts.co','nntexts.co', 'https://nntextapp.herokuapp.com']
...
WSGI_APPLICATION = 'nntext.wsgi.application'
...
DEFAULT_HOST = 'www'
DEFAULT_REDIRECT_URL = 'http://www.nntexts.com'
